...
***/ 
function getRandomquote(){                                             // random function to get random quotes from the quotes array
  let randomquote = quotes[Math.floor(Math.random()*quotes.length)];     // getting random quotes from the quote list
  console.log(randomquote);
  return randomquote;                                        // returning random qup-ote to the print quote function
}
...
function printQuote(){                                                   //print quote function to display the quote and other elements in the html page
  let randomQuote = getRandomquote();                                 // getting random quote from the get random quote function
  let result = `<p class = 'quote'>${randomQuote.quote}</p>             
  <p class = "source">${randomQuote.source}`;                      // creating a string named result to store quote , year , citation and source
  if (randomQuote.year)
  {
  ...
  document.querySelector('.quote-box').innerHTML = result;                        // displaying the result in the html page
}
